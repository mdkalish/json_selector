...
/***/ function(module, exports, __webpack_require__) {
	...
	function render(domElement, fullcontactData, sObjectData) {
	  ...
	  */
	  ...
	  _reactDom2.default.render(_react2.default.createElement(_App2.default, { fullcontactData: fullcontactData,
	    sObjectData: sObjectData }), domElement);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SocialProfiles = _react2.default.createClass({
	  ...
	  matchCounterpart: function matchCounterpart(key, value, type) {
	    ...
	    try {
	      for (var _iterator = sObjectSocialMedia[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
